        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
             ...
             migrationBuilder.CreateTable(
                 ...
                 constraints: table =>
                 {
                     table.PrimaryKey("PK__Categori__3214EC07C7E06C03", x => x.Id);
                 }); 
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Image9x16 = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    Image16x9 = table.Column<byte[]>(type: "varbinary(max)", nullable: true),
                    ...
                    OrganizerName = table.Column<string>(type: "nvarchar(255)", maxLength: 255, nullable: true),
                    OrganizerInfo = table.Column<string>(type: "nvarchar(max)", nullable: true),
                    OrganizerLogo = table.Column<byte[]>(type: "varbinary(max)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK__Events__3214EC07FF70E776", x => x.Id);
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "UQ__Categori__737584F6773C92D3",
                table: "Categories",
                column: "Name",
                unique: true);
